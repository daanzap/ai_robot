...
from strategies.StudentStrategyKeras import AutoSteerKeras
...
pilot_classic = AutoSteer()
pilot_keras = AutoSteerKeras()
...
while True:
    ...
    if keys[pygame.K_a]:
        auto_pilot = True
        auto_pilot_direction = pilot_classic.steer(camera_view)
        speed_setting = 4
    if keys[pygame.K_k]:
        auto_pilot = True
        auto_pilot_direction = pilot_keras.steer(camera_view)
        speed_setting = 6
